import { EventBus, EventsHandler, ICommandHandler, IEventHandler } from '@nestjs/cqrs';
...
export class PlayerDisconnectedSubscriber implements IEventHandler<PlayerDisconnectedEvent> {
  constructor(private lobbyStore: LobbyStore, private playerStore: PlayerStore, private eventBus: EventBus) {
  }
